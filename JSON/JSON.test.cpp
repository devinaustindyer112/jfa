...
TEST_CASE("Nested array equals different value", "[Nested array equals different value]")
{
    ...
    JSONValue *val4 = new JSONValue("foo");
    arr2->push(val4);
    arr2->push(val4);
    arr2->push(val4);
...
TEST_CASE("Nested array value equals value", "[Nested array value equals value]")
{
    Array<JSONValue> *arr1 = new Array<JSONValue>();
    JSONValue *val1 = new JSONValue("foo");
    arr1->push(val1);
