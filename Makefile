main: JSON/JSONObject.hpp JSON/JSONObject.cpp JSON/JSONValue.cpp JSON/JSONValue.hpp  Parser/Parser.cpp Parser/Parser.hpp  Utilities/Utilities.cpp Tokenizer/Tokenizer.cpp String/String.cpp Array/Array.cpp Main.cpp
	g++ -std=c++14 -o main JSON/JSONObject.cpp JSON/JSONValue.cpp Array/Array.cpp Parser/Parser.cpp Utilities/Utilities.cpp Tokenizer/Tokenizer.cpp String/String.cpp Main.cpp
