main: Utilities/Utilities.cpp String/String.cpp Array/Array.cpp Main.cpp
	g++ -std=c++14 -o main Utilities/Utilities.cpp String/String.cpp Main.cpp Array/Array.cpp
